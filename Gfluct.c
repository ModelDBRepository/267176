...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 1, "pntproc");
 	...
 	ivoc_help("help ?1 Gfluct E:/motoneuron pool(4)(LOAD FF)/motoneuron recruitment/Gfluct.mod\n");
...
{
 { error =  oup();
 if(error){fprintf(stderr,"at line 142 in file Gfluct.mod:\n	SOLVE oup\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
static const char* nmodl_file_text = 
  ...
  "\n"
  "     std_e = 0.032 (umho)	: standard dev of excitatory conductance\n"
