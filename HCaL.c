...
#define nrn_init _nrn_init__HCaL
#define _nrn_initial _nrn_initial__HCaL
#define nrn_cur _nrn_cur__HCaL
#define _nrn_current _nrn_current__HCaL
#define nrn_jacob _nrn_jacob__HCaL
#define nrn_state _nrn_state__HCaL
#define _net_receive _net_receive__HCaL 
#define _f_settables _f_settables__HCaL 
#define settables settables__HCaL 
#define states states__HCaL 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_HCaL", _hoc_setdata,
 "settables_HCaL", _hoc_settables,
 0, 0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "cvodeieq");
 	...
 	ivoc_help("help ?1 HCaL E:/motoneuron pool(4)(LOAD FF)/motoneuron recruitment/HCaL.mod\n");
...
static int  _f_settables ( _threadargsprotocomma_ double _lv ) {
   double _ltmp ;
 alpha = 0.025 / ( 1.0 + exp ( ( _lv + 30.0 + 10.0 ) / - 7.0 ) ) ;
   beta = 0.025 / ( 1.0 + exp ( ( _lv + 30.0 + 10.0 ) / 7.0 ) ) ;
    return 0; }
...
#if NMODL_TEXT
static const char* nmodl_filename = "HCaL.mod";
static const char* nmodl_file_text = 
