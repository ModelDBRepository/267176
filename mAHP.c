...
static void _check_mcarate(double*, Datum*, Datum*, _NrnThread*); 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 6, "cvodeieq");
 	...
 	ivoc_help("help ?1 mAHP E:/motoneuron pool(4)(LOAD FF)/motoneuron recruitment/mAHP.mod\n");
...
static void _hoc_rates(void) {
 ...
 static double _mfac_mcarate, _tmin_mcarate;
  static void _check_mcarate(double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt) {
 ...
 static int mcarate(double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt, double _lv) { 
#if 0
_check_mcarate(_p, _ppvar, _thread, _nt);
#endif
 ...
 static void _n_mcarate(double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt, double _lv){ int _i, _j;
 double _xi, _theta;
 if (!usetable) {
