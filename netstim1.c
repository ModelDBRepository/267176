...
#define next_invl next_invl__NetStim1 
#define noiseFromRandom noiseFromRandom__NetStim1 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 NetStim1 E:/motoneuron pool(4)(LOAD FF)/motoneuron recruitment/netstim1.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "netstim1.mod";
static const char* nmodl_file_text = 
