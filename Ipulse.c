...
#define nrn_init _nrn_init__Ipulse
#define _nrn_initial _nrn_initial__Ipulse
#define nrn_cur _nrn_cur__Ipulse
#define _nrn_current _nrn_current__Ipulse
#define nrn_jacob _nrn_jacob__Ipulse
#define nrn_state _nrn_state__Ipulse
#define _net_receive _net_receive__Ipulse 
...
#define x _p[1007]
#define ix _p[1008]
#define ampli _p[1009]
#define ival _p[1010]
#define on _p[1011]
#define tally _p[1012]
#define v _p[1013]
#define _g _p[1014]
#define _tsav _p[1015]
...
static void nrn_alloc(Prop* _prop) {
  ...
  if (nrn_point_prop_) {
	...
	_ppvar = nrn_point_prop_->dparam;
 	...
 	_p = nrn_prop_data_alloc(_mechtype, 1016, _prop);
...
extern void _cvode_abstol( Symbol**, double*, int);
...
#endif
  hoc_register_prop_size(_mechtype, 1016, 3);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 Ipulse E:/motoneuron pool(4)(LOAD FF)/motoneuron recruitment/Ipulse.mod\n");
...
static double _nrn_current(double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt, double _v){double _current=0.;v=_v;{ {
   i = ival ;
   x = ampli * sin ( 2.0 * PI * 0.001 * ( t - 125.0 ) ) ;
   ix = i + x ;
   }
 _current += ix;
...
#if NMODL_TEXT
static const char* nmodl_filename = "Ipulse.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  "  ipulse3.mod\n"
